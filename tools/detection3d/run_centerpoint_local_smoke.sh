...
while [[ $# -gt 0 ]]; do
  case "$1" in
    ...
    -h|--help)
      cat <<'EOF'
Usage:
  run_centerpoint_local_smoke.sh [--zero] [DATA_ROOT] [CHECKPOINT_PATH]
  run_centerpoint_local_smoke.sh [--zero] --pointcloud-bin <FILE> [--pointcloud-bin <FILE> ...] [CHECKPOINT_PATH]
